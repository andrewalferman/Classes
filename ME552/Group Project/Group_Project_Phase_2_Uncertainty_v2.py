...
deltaP = unc.ufloat(0.1028, press) # Measured value during calbibration
deltaPpitot = unc.ufloat(0.11, press) # Measured value during calbibration

# Absolute pressure in Pascals
Pabsolute = unc.ufloat(1017.6666666, barometer) * mbartopa
...
Tambient = unc.ufloat(295.17, thermometer) # Measured value during calibration
