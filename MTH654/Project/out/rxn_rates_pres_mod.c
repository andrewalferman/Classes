...
void get_rxn_pres_mod (const double T, const double pres, const double * __restrict__ C, double * __restrict__ pres_mod) {
  ...
  // reaction 5;
  pres_mod[0] = m + 0.8999999999999999 * C[10] + 2.8 * C[11] - 1.0 * C[9] - 1.0 * C[8] + 1.5 * C[1] + 11.0 * C[4];

  // reaction 8;
  pres_mod[1] = m + 0.8999999999999999 * C[10] + 2.8 * C[11] - 1.0 * C[9] - 1.0 * C[8] + 1.5 * C[1] + 11.0 * C[4];

  // reaction 11;
  pres_mod[2] = m + 0.8999999999999999 * C[10] + 2.8 * C[11] - 0.25 * C[9] - 0.25 * C[8] + 1.5 * C[1] + 11.0 * C[4];

  // reaction 12;
  pres_mod[3] = m + 0.8999999999999999 * C[10] + 2.8 * C[11] + 0.10000000000000009 * C[9] + 0.5 * C[5] + 1.0 * C[12] + 2.0 * C[1] - 1.0 * C[4];

  // reaction 14;
  thd = m + 0.8999999999999999 * C[10] + 2.8 * C[11] - 0.19999999999999996 * C[9] - 0.21999999999999997 * C[5] - 0.32999999999999996 * C[8] + 1.0 * C[1] + 13.0 * C[4];
  ...
  // reaction 21;
  thd = m + 1.7999999999999998 * C[10] + 6.7 * C[7] + 0.6000000000000001 * C[11] - 0.35 * C[9] + 0.19999999999999996 * C[5] + 0.5 * C[12] + 2.7 * C[1] + 6.5 * C[4];
